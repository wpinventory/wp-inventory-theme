...
function acg_testimonials_taxonomy() {
	...
	register_taxonomy( 'testicat', 'testicat', [
		'hierarchical' => TRUE,
		'labels'       => $labels,
		'query_var'    => TRUE,
...
class acg_testimonials_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$title        = ( ! empty( $instance['title'] ) && $instance['title'] != '' ) ? strip_tags( $instance['title'] ) : '';
		$number       = ( ! empty( $instance['number'] ) && $instance['number'] != '' ) ? strip_tags( $instance['number'] ) : '';
		$readmore     = ( ! empty( $instance['readmore'] ) && $instance['readmore'] != '' ) ? strip_tags( $instance['readmore'] ) : '';
		$viewall      = ( ! empty( $instance['viewall'] ) && $instance['viewall'] != '' ) ? strip_tags( $instance['viewall'] ) : '';
		$categoryid   = ( ! empty( $instance['categoryid'] ) && $instance['categoryid'] != '' ) ? $instance['categoryid'] : 0;
		$viewallurl   = ( ! empty( $instance['viewallurl'] ) && $instance['viewallurl'] != '' ) ? strip_tags( $instance['viewallurl'] ) : '';
		$showtitle    = ( ! empty( $instance['showtitle'] ) ) ? $instance['showtitle'] : '2';
		$showtext     = ( ! empty( $instance['showtext'] ) ) ? $instance['showtext'] : 0;
		$showaddress  = ( ! empty( $instance['showaddress'] ) ) ? $instance['showaddress'] : 0;
		$showwebsite  = ( ! empty( $instance['showwebsite'] ) ) ? $instance['showwebsite'] : 0;
		$titlelink    = ( ! empty( $instance['titlelink'] ) ) ? $instance['titlelink'] : 0;
		$controlsmove = ( ! empty( $instance['controlsmove'] ) ) ? $instance['controlsmove'] : 0;

		$orderby   = ( ! empty( $instance['orderby'] ) ) ? $instance['orderby'] : 'title';
		$order     = ( ! empty( $instance['order'] ) ) ? $instance['order'] : 'DESC';
		$animate   = ( ! empty( $instance['animate'] ) ) ? $instance['animate'] : 'both';
		$imagesize = ( ! empty( $instance['imagesize'] ) ) ? $instance['imagesize'] : 'thumbnail';

		$delay = ( ! empty( $instance['delay'] ) && $instance['delay'] != '' ) ? $instance['delay'] : 0;
		?>
        ...
        <p><label for="<?php echo $this->get_field_id( 'categoryid' ); ?>"><?php _e( 'Category:' ); ?></label>
			...
			foreach ( $opts AS $v => $l ) {
				...
				$sizeselect .= ( $v == $imagesize ) ? ' selected' : '';
				$sizeselect .= '>' . $l . '</option>';
			}
			$sizeselect .= '</select>';
		...
		<?php $checked = ( $showtitle ) ? ' checked="checked"' : ''; ?>
		...
		<?php $checked = ( $showtext ) ? ' checked="checked"' : ''; ?>
		...
		<?php $checked = ( $showaddress ) ? ' checked="checked"' : ''; ?>
		...
		<?php $checked = ( $showwebsite ) ? ' checked="checked"' : ''; ?>
		...
		<?php $checked = ( $titlelink ) ? ' checked="checked"' : ''; ?>
		...
		<?php $checked = ( $controlsmove ) ? ' checked="checked"' : ''; ?>
